					...
					<div className={checkBoxClasses.root}>
						...
						>
							...
							<FormGroup>
								...
								<FormControlLabel
									control={<CheckboxWithGreenCheck name="11-20" onChange={getSelected} />}
									label={ <Typography className = { checkBoxClasses.filterTextOptions}> 11 - 20 kms </Typography> }
								/>
								<FormControlLabel
									control={<CheckboxWithGreenCheck name="21-30" onChange={getSelected}/>}
									label={ <Typography className = { checkBoxClasses.filterTextOptions}> 21 - 30 kms </Typography> }
								/>
								<FormControlLabel
									control={<CheckboxWithGreenCheck name="31-40" onChange={getSelected}/>}
